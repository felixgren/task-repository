        ...
        <div
            ...
            <div>
                <img class="border-2 border-gray-300 rounded-lg w-40 h-40 m-auto my-3 object-cover dark:border-transparent"
                    src="" alt="Your profile.. sooner or later...">
            </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="my-4">
                    ...
                    <textarea name="description" id="description"
                        class="bg-gray-100 border-solid border border-black border-opacity-40 w-full p-1 rounded-sm dark:bg-transparent dark:border-white @error('description') border-red-500 border-opacity-100  @enderror">{{ old('description') ? old('description') : $user->description }}</textarea>
