...
@section('content')
    <div class="flex justify-center md:mt-8">
        <div
            ...
            <h2 class="">Welcome. Please enter your details</h2>
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="my-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Choose password"
                        class="bg-gray-100 border-solid border border-black border-opacity-40 w-full p-1 rounded-sm dark:bg-transparent dark:border-white @error('password') border-red-500 border-opacity-100  @enderror"
                        value="">
